...
export const CONTROL_REGISTRY: ControlDefinition[] = [
  ...
  {
    id: 'lyrics-only-mode',
    displayName: 'Lyrics Only Mode',
    description:
      'Disables all background visual effects and shows only lyrics over a static background. Perfect for clean, simple lyric videos.',
    storePath: 'visualSettings.lyricsOnlyMode',
    storeType: 'visualSettings',
    domSelector: '[data-control-id="lyrics-only-mode"]',
    panelLocation: 'left',
    sectionName: 'FX Controls',
    controlType: 'toggle',
    valueType: 'boolean',
    ...
    actionVerbs: ['enable', 'disable', 'turn on', 'turn off', 'toggle', 'use', 'switch to'],
  },
  {
    id: 'font-size-scale',
    displayName: 'Font Size',
    description: 'Controls the size of lyrics text, from small (0.5x) to large (2x)',
    storePath: 'visualSettings.fontSizeScale',
    storeType: 'visualSettings',
    domSelector: '[data-control-id="font-size-scale"]',
    panelLocation: 'left',
    sectionName: 'FX Controls',
    controlType: 'slider',
    valueType: 'number',
    validValues: { min: 0.5, max: 2, step: 0.1 },
    requiresAdvancedMode: false,
    synonyms: [
      'font size',
      'text size',
